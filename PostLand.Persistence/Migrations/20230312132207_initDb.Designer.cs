...
namespace PostLand.Persistence.Migrations
{
    ...
    [Migration("20230312132207_initDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PostLand.Domainn.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PostLand.Domainn.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PostLand.Domainn.Post", b =>
                {
                    b.HasOne("PostLand.Domainn.Category", "Category")
                        .WithMany("Blogs")
